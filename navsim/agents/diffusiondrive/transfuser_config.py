...
class TransfuserConfig:
    ...
    bkb_path: str = "/home/mount/DiffusionDrive/checkpoints/resnet34.a1_in1k/pytorch_model.bin"
    plan_anchor_path: str = "/home/mount/DiffusionDrive/checkpoints/kmeans_navsim_traj_20.npy"
